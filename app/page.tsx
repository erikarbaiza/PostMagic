...
function LinkedInPreview({ text }: { text: string }) {
  ...
  const preview =
    !expanded && text.length > 220 ? text.slice(0, 220) + "..." : text;
  ...
  return (
    ...
    >
      <div style={{ display: "flex", gap: "12px", marginBottom: "14px" }}>
        <div
          style={{
            ...
            height: 48,
            borderRadius: "50%",
            background: "linear-gradient(135deg, #e88a3c, #c0622a)",
            display: "flex",
            alignItems: "center",
        ...
        <div>
          <div
            style={{ fontWeight: 700, fontSize: 14, color: "#e8e4dc" }}
          >
            Erik Arbaiza
          </div>
          <div
      ...
      >
        ...
        <span style={{ marginLeft: "auto" }}>↗ Compartir</span>
      </div>
    </div>
  );
}
...
function UsageBar({
  ...
  const pct = Math.min(usage.used / usage.limit, 1);
  ...
  return (
    <div
      style={{
        ...
        border: `1px solid ${
          isAtLimit ? "rgba(248,113,113,0.25)" : "rgba(255,255,255,0.07)"
        }`,
        borderRadius: 12,
      }}
    >
      ...
      {isAtLimit ? (
        ...
        >
          ...
          <button
            ...
            style={{
              ...
              alignItems: "center",
              gap: 5,
              background: "linear-gradient(135deg, #f59e0b, #e88a3c)",
              border: "none",
              color: "#09090a",
              padding: "5px 12px",
              borderRadius: 7,
        ...
        >
          <span style={{ fontSize: 12, color: "#fbbf24" }}>
            Solo te quedan {usage.remaining} generaciones
          </span>
          <button
            onClick={onUpgrade}
            style={{
        ...
        <span style={{ fontSize: 12, color: "rgba(255,255,255,0.2)" }}>
          {usage.remaining} generaciones restantes este mes
        </span>
      )}
    </div>
  );
...
export default function PostMagic() {
  ...
  const [activeTab, setActiveTab] = useState<"historial" | "favoritos">(
    "historial"
  );
  ...
  useEffect(() => {
    editableResultRef.current = editableResult;
  }, [editableResult]);
  ...
  const normalizeUsage = (data: Partial<UsageData> | null | undefined): UsageData => {
  ...
  useEffect(() => {
    if (!isSignedIn) {
      setUsage({ used: 0, limit: 30, remaining: 30, isPro: false });
      return;
    }
    ...
    try {
      const res = await fetch("/api/generate", {
        ...
        body: JSON.stringify({
          ...
          type: activeType || selectedPlatform,
          mode: "rewrite",
          rewriteStyle: `Genera SOLO 5 hashtags virales para ${
            TYPE_LABELS[activeType || selectedPlatform]
          }, uno por línea, sin explicaciones, solo los hashtags con #`,
          audience,
          goal,
        }),
      });
      ...
      <div style={{ display: "flex", gap: 4, marginLeft: 12, flexShrink: 0 }}>
        <button
          ...
          style={{
            ...
            padding: 4,
            borderRadius: 6,
            color: isFavorite(item.id) ? "#fbbf24" : "rgba(255,255,255,0.15)",
        ...
        <button
          onClick={(e) => {
            e.stopPropagation();
            deleteFromHistory(item.id, list);
          }}
          style={{
            background: "none",
            border: "none",
    ...
    >
      ...
      <div
        style={{
          ...
          width: "50vw",
          height: "50vw",
          background: "radial-gradient(circle, rgba(232,138,60,0.06) 0%, transparent 70%)",
          pointerEvents: "none",
          zIndex: 0,
        }}
      />
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
        ...
        <div style={{ display: "flex", gap: 10, alignItems: "center" }}>
          {!usage.isPro && (
            ...
            >
              <Crown size={13} />
              {checkingOut ? "Redirigiendo..." : "Upgrade a Pro"}
            </button>
          )}
      ...
      >
        <div
          style={{
            ...
            gap: 8,
            background: "rgba(232,138,60,0.1)",
            border: "1px solid rgba(232,138,60,0.2)",
            borderRadius: 100,
            padding: "5px 14px",
            marginBottom: 20,
          }}
        ...
        >
          Genera posts para LinkedIn, hilos para X y guiones de TikTok en segundos.
          Escribe una idea y PostMagic la convierte en contenido listo para publicar.
        </p>
        ...
        >
          Ideal para founders, marketers, creadores y freelancers
        </p>
      </div>
      ...
      >
        ...
        {limitError && (
          ...
          >
            <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
              ...
              >
                Has alcanzado el límite de 30 generaciones gratuitas este mes.
                Actualiza a Pro para seguir generando sin límite.
              </span>
            </div>
        ...
        >
          ...
          >
            ...
            <input
              ...
              placeholder="Ej: programadores, abogados..."
              style={{
                width: "100%",
          ...
          >
            ...
            >
              {GOALS.map((g) => (
                <option key={g.key} value={g.key} style={{ background: "#111" }}>
                  {g.label}
                </option>
              ))}
            </select>
        ...
        >
          ...
          >
            ...
            <button
              ...
              disabled={
                !input.trim() || loading || (!usage.isPro && usage.remaining === 0)
              }
              style={{
                display: "flex",
                alignItems: "center",
            ...
            >
              {loading && loadingAction === "full" ? (
                ...
                <>
                  ...
                  Generar {TYPE_LABELS[selectedPlatform]}
                </>
              )}
            </button>
          </div>
        ...
        {editableResult && (
          <div
            ref={resultRef}
            style={{
              background: "rgba(232,138,60,0.05)",
              border: "1px solid rgba(232,138,60,0.2)",
              borderRadius: 16,
              padding: 28,
              marginBottom: 32,
          ...
          >
              ...
              <div style={{ display: "flex", gap: 8, flexWrap: "wrap" }}>
                <button
                  ...
                  style={{
                    ...btnBase,
                    border: showPreview
                      ? "1px solid rgba(232,138,60,0.4)"
                      : (btnBase.border as string),
                    color: showPreview ? "#e88a3c" : btnBase.color,
                  }}
                >
                ...
                <button
                  ...
                  style={{
                    ...
                    border: savedFlash
                      ...
                      : (btnBase.border as string),
                    color: savedFlash ? "#fbbf24" : btnBase.color,
                  }}
                >
                  <Star size={12} fill={savedFlash ? "#fbbf24" : "none"} />
                  {savedFlash ? "¡Guardado!" : "Guardar"}
                </button>

                <button
                  onClick={() => handleCopy(editableResult)}
                  style={{
                    ...btnBase,
                    background: copied
                      ? "rgba(34,197,94,0.1)"
            ...
            <div style={{ display: "flex", gap: 8, flexWrap: "wrap", marginTop: 4 }}>
              {["más viral", "más corto", "más profesional", "más divertido"].map(
                (styleLabel) => (
                  <button
                    key={styleLabel}
                    onClick={() =>
                      generateContent(activeType || selectedPlatform, "rewrite", styleLabel)
                    }
                    disabled={loading}
                    style={{
                      ...btnBase,
                      opacity: loading && loadingAction === styleLabel ? 0.5 : 1,
                    }}
                  >
                    {loading && loadingAction === styleLabel ? (
                      <span
                        style={{
                          width: 10,
                          height: 10,
              ...
              <button
                onClick={() =>
                  generateContent(
                    activeType || selectedPlatform,
                    "rewrite",
                    "Mejora este contenido haciéndolo más claro, viral y atractivo, manteniendo la idea original"
                  )
                }
                disabled={loading}
                style={{
              ...
              >
                {loading && loadingAction === "hashtags" ? (
                  <span
                    style={{
                      width: 10,
                      height: 10,
              ...
              <button
                onClick={() => generateContent(selectedPlatform, "hooks")}
                disabled={!input.trim() || loading}
                style={{
                  ...btnBase,
                  background: "rgba(232,138,60,0.12)",
                  border: "1px solid rgba(232,138,60,0.25)",
                  color: "#e88a3c",
                }}
              >
                Hooks virales
        ...
        {(history.length > 0 || favorites.length > 0) && (
          <div>
            ...
            >
              {[
                { key: "historial", label: "Historial", Icon: Clock, count: history.length },
                { key: "favoritos", label: "Favoritos", Icon: Star, count: favorites.length },
              ].map((tab) => (
                <button
                  key={tab.key}
                  onClick={() =>
                    setActiveTab(tab.key as "historial" | "favoritos")
                  }
                  style={{
                    flex: 1,
                    display: "flex",
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
              {activeTab === "historial"
                ...
                ? (
                  ...
                  >
                    Aún no tienes favoritos. Pulsa ⭐ en cualquier post.
                  </p>
                )
